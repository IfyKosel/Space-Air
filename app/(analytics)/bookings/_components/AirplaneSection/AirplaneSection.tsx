  ...
  return (
    <article className="w-full">
      <div className="w-full flex flex-col gap-5">
        <div className="flex justify-between gap-5 lg:px-3 items-center h-fit">
          <div className="flex flex-col gap-1 items-center">
            <Image src={Gulf} alt="airline Logo" height={45} width={45} />
            <span className="text-[10px] md:text-xs text-[#868686]">
              Gulf Air
            </span>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs md:text-sm text-[#202020] text-center">
            ...
            <div className="flex justify-center sm:justify-start ">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-xs md:text-sm text-[#202020]">
          ...
          <div className="flex flex-col gap-4 pr-4 min-[510px]:pr-0">
        ...
        <div className="w-full flex gap-6 px-5">
          <div className="flex flex-col gap-2 w-fit text-xs md:text-sm text-end">
            ...
            <p className="text-xs md:text-sm text-[#202020]">Business</p>
          </div>
          <div className="flex flex-col gap-2 w-fit text-xs md:text-sm text-end">
            <p className="text-[#868686] ">Flight Number</p>
            <p className="text-xs md:text-sm text-[#202020]">165</p>
          </div>
        </div>
      </div>
    </article>
